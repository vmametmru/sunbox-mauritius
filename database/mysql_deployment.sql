...
CREATE TABLE quotes (
    ...
    contact_id INT NULL,
    is_free_quote BOOLEAN DEFAULT FALSE COMMENT 'True for free-form quotes created by admin',
    quote_title VARCHAR(255) NULL COMMENT 'Custom title for free quotes',
    photo_url VARCHAR(500) NULL COMMENT 'Optional photo URL for the quote',
    ...
    INDEX idx_is_free_quote (is_free_quote),
    INDEX idx_cloned_from (cloned_from_id),
