...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: DollarSign, label: 'Pricelist', path: '/admin/pricelist' },
...
const groupPaths: Record<string, string[]> = {
  ...
  parametres: [
    ...
    '/admin/boq', '/admin/pricelist', '/admin/pool-variables', '/admin/pool-template',
    '/admin/modular-variables', '/admin/modular-template',
    '/admin/model-types',
