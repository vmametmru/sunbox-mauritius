...
const UNITS = [
  'unité', 'jour', 'm²', 'm³', 'tonne', 'barre', 'sac', 'forfait',
  'planche', 'bouteille', 'kit', 'mètre', 'kg', 'lot', 'litre',
];
...
export default function ModularBOQPriceListPage() {
  ...
  const saveItem = async () => {
    ...
    try {
      setSaving(true);
      if (editing.id) {
        await api.updateModularBOQPriceListItem({
          id: editing.id,
          name: editing.name,
          unit: editing.unit,
        ...
        await api.createModularBOQPriceListItem({
          name: editing.name,
          unit: editing.unit,
          unit_price: editing.unit_price,
          has_vat: editing.has_vat,
  ...
  const deleteItem = async (id: number) => {
    ...
    try {
      await api.deleteModularBOQPriceListItem(id);
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  onCheckedChange={checked => setEditing({ ...editing, has_vat: checked })}
                />
