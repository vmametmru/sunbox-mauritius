...
export function MediaPage() {
  ...
  async function loadList() {import React, { useEffect, useState } from "react";
...
export default function MediaPage() {
  ...
  async function loadList() {
    ...
    try {
      // Optionnel: si tu veux lister UNIQUEMENT un modèle/plan précis, mets refId
  ...
  async function uploadOne(e: React.FormEvent) {
    ...
    // Le backend accepte "file" OU "image"
